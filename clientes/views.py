...
# Vista para registro de usuario (solo username y password)
...
# Vista para historial de clientes entregados
...
# Vista para mostrar los días de la semana
from django.shortcuts import render
def home(request):
    dias = ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo']
    return render(request, 'home.html', {'dias': dias})

# Vista para mostrar clientes por día y cambiar estado, eliminar
